...
12. [Gemini CLI와 Google Code Assist Agent Mode](#12-gemini-cli와-google-code-assist-agent-mode)
13. [상호호환성 종합 매핑](#13-상호호환성-종합-매핑)
14. [통합 실전 가이드 및 팁](#14-통합-실전-가이드-및-팁)
15. [참고 문헌](#15-참고-문헌)
...
> *   **통합 관리 위치**: 설정을 한곳에 모으기 위해 `.gemini/GEMINI.md` 경로를 사용할 수도 있습니다. 이 경우 `settings.json` 내의 `context.fileName`에 해당 경로를 명시해야 에이전트가 올바르게 로드할 수 있습니다. (14.1 통합 디렉토리 구조 참조)
...
## 12. Gemini CLI와 Google Code Assist Agent Mode
